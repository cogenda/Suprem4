...
{
       0,     0,     3,     5,     8,    13,    15,    17,    19,    22,
      26,    31,    36,    42,    44,    46,    49,    52,    55,    56,
      58,    59,    62,    63,    67,    71,    75,    79,    83,    87,
      91,    95,    99,   102,   106,   110,   112,   114,   116
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      33,     0,    -1,    34,    -1,    33,    34,    -1,    35,    38,
      39,     7,    -1,    27,    -1,     4,    -1,     5,    -1,     1,
       7,    -1,    36,    24,    37,    -1,    36,    24,    37,    25,
      -1,    36,    24,    37,    23,    -1,    36,    24,    37,    25,
      23,    -1,     3,    -1,     6,    -1,    29,    20,    -1,    29,
      21,    -1,    29,    22,    -1,    -1,    26,    -1,    -1,     8,
      40,    -1,    -1,    30,    40,    31,    -1,    40,     9,    40,
      -1,    40,    10,    40,    -1,    40,    11,    40,    -1,    40,
      12,    40,    -1,    40,    13,    40,    -1,    40,    14,    40,
      -1,    40,    15,    40,    -1,    40,    16,    40,    -1,    17,
...
#line 105 "parser.y"
    {
		...
		*((yyvsp[(2) - (3)].sval) + 11) = '\0';
	    strcpy(current[0]->name, (yyvsp[(2) - (3)].sval));
	    current[0]->units = NULL;
	    current[0]->type = (yyvsp[(1) - (3)].ival);
	}
    break;
...
#line 113 "parser.y"
    {
		...
		*((yyvsp[(2) - (4)].sval) + 11) = '\0';
	    strcpy(current[0]->name, (yyvsp[(2) - (4)].sval));
	    current[0]->units = (yyvsp[(4) - (4)].sval);
	    current[0]->type = (yyvsp[(1) - (4)].ival);
	}
    break;
...
#line 121 "parser.y"
    {
		...
		*((yyvsp[(2) - (4)].sval) + 11) = '\0';
	    strcpy(current[0]->name, (yyvsp[(2) - (4)].sval));
	    current[0]->units = NULL;
	    current[0]->type = (yyvsp[(1) - (4)].ival) | ((yyvsp[(4) - (4)].ival) & INDEX);
	}
    break;
...
#line 129 "parser.y"
    {
		...
		*((yyvsp[(2) - (5)].sval) + 11) = '\0';
	    strcpy(current[0]->name, (yyvsp[(2) - (5)].sval));
	    current[0]->units = (yyvsp[(4) - (5)].sval);
	    current[0]->type = (yyvsp[(1) - (5)].ival) | ((yyvsp[(5) - (5)].ival) & INDEX);
	}
    break;
...
#line 200 "parser.y"
    {
	    val_str t;
	    t.ival = '>';
	    (yyval.bval) = node(OPER, t, (yyvsp[(1) - (3)].bval), (yyvsp[(3) - (3)].bval));
	}
    break;
...
#line 248 "parser.y"
    {
	    val_str t;
	    t.ival = '!';
	    (yyval.bval) = node(OPER, t, NULL, (yyvsp[(2) - (2)].bval));
	}
    break;
