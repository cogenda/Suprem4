h12471
s 00000/00018/00090
d D 2.1 93/02/03 15:34:25 suprem45 2 1
c Initial IV.GS release
e
s 00108/00000/00000
d D 1.1 93/02/03 15:33:26 suprem45 1 0
c date and time created 93/02/03 15:33:26 by suprem45
e
u
U
f e 0
...
struct line *p;
{
    ...
    /*draw the new profile - see what we have*/
    gmove( p[0].x, p[0].y );
    gmove( p[0].x, p[0].y );
    for( i = 1; i < n; i++ ) {
	gdraw( p[i].x, p[i].y );
