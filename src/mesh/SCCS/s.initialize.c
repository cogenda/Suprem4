h46555
s 00043/00006/00091
d D 2.1 93/02/03 15:23:10 suprem45 2 1
...
E 2
	switch( imp ) {
D 2
	case B: add_impurity( Ba, conc, -1 );  break;
	case Sb: add_impurity( Sba, conc, -1 );  break;
	case As: add_impurity( Asa, conc, -1 );  break;
	case P: add_impurity( Pa, conc, -1 );  break;
E 2
I 2
	case As  : impa = Asa;
		   break;
