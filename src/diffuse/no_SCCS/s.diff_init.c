h03783
s 00322/00024/00281
d D 2.1 93/02/03 14:46:54 suprem45 2 1
c Initial IV.GS release
e
s 00305/00000/00000
d D 1.1 93/02/03 14:41:21 suprem45 1 0
c date and time created 93/02/03 14:41:21 by suprem45
e
u
U
f e 0
...
D 2
    /*set the flags for the velocities and stresses, active conc*/
    impur[ XVEL ].flags = impur[ YVEL ].flags = impur[ DELA ].flags = 0;
    impur[Asa].flags = impur[Sba].flags = impur[Pa].flags = impur[Ba].flags = 0;
    impur[ Sxx].flags = impur[ Syy].flags = impur[ Sxy].flags = 0;
    impur[ GRN].flags = 0;
E 2
    ...
    for(mat = 0; mat < MAXMAT; mat++) {
D 2
	for(i = 0; i < 25; impur[V].constant[mat][i++] = 0.0);
E 2
I 2
	for(i = 0; i < 25; i++) {
...
E 2
    ...
    for(mat = 0; mat < MAXMAT; mat++) {
D 2
	for(i = 0; i < 25; impur[I].constant[mat][i++] = 0.0);
E 2
I 2
	for(i = 0; i < 25; i++) {
...
E 2
    ...
    for(mat = 0; mat < MAXMAT; mat++) {
D 2
	for(i = 0; i < 25; impur[As].constant[mat][i++] = 0.0);
E 2
I 2
	for(i = 0; i < 25; i++) {
...
E 2
    ...
    for(mat = 0; mat < MAXMAT; mat++) {
D 2
	for(i = 0; i < 25; impur[P].constant[mat][i++] = 0.0);
E 2
I 2
	for(i = 0; i < 25; i++) {
...
E 2
    ...
    for(mat = 0; mat < MAXMAT; mat++) {
D 2
	for(i = 0; i < 25; impur[Sb].constant[mat][i++] = 0.0);
E 2
I 2
	for(i = 0; i < 25; i++) {
...
D 2
	for(i = 0; i < 25; 
	    impur[Ga].constant[mat][i] = impur[B].constant[mat][i] = 0.0, i++);
E 2
I 2
	for(i = 0; i < 25; i++) {
...
E 2
    ...
    for(mat = 0; mat < MAXMAT; mat++) {
D 2
	for(i = 0; i < 25; impur[O2].constant[mat][i++] = 0.0);
E 2
I 2
	for(i = 0; i < 25; i++) {
...
D 2
    impur[O2].flags = DIFFUSING | MOBILE | LOCKSTEP | STEADY ;
E 2
I 2
...
E 2
    ...
    for(mat = 0; mat < MAXMAT; mat++) {
D 2
	for(i = 0; i < 25; impur[H2O].constant[mat][i++] = 0.0);
E 2
I 2
	for(i = 0; i < 25; i++) {
...
D 2
    impur[H2O].flags = DIFFUSING | MOBILE | LOCKSTEP | STEADY ;
E 2
I 2
...
E 2
    ...
    for(mat = 0; mat < MAXMAT; mat++) {
D 2
	for(i = 0; i < 25; impur[Au].constant[mat][i++] = 0.0);
E 2
I 2
	for(i = 0; i < 25; i++) {
...
#ifndef DEVICE
D 2
    impur[Psi].flags = PSEUDO | MOBILE | DIFFUSING | STEADY | LOCKSTEP;
E 2
I 2
...
E 2
    ...
    for(mat = 0; mat < MAXMAT; mat++) {
D 2
	for(i = 0; i < 25; impur[Cs].constant[mat][i++] = 0.0);
E 2
I 2
	for(i = 0; i < 25; i++) {
