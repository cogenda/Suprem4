h47064
s 00031/00016/00209
d D 2.1 93/02/03 14:46:47 suprem45 2 1
...
D 2
#define K0(M)	impur[Au].constant[M][1] /*pre exp constant with neutral V*/
#define KE(M)	impur[Au].constant[M][2] /*exp constant with neutral V*/
E 2
I 2
...
D 2
    if (is_specified(param, "K.0"))    K0(mat)    = get_float( param, "K.0" );
    if (is_specified(param, "K.E"))    KE(mat)    = get_float( param, "K.E" );
E 2
I 2
    i = 0; j = 1;
