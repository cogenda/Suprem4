h17571
s 00082/00048/00709
d D 2.1 93/02/03 14:46:48 suprem45 2 1
...
D 2
	    tot = n * ( Dfrac[ip][mat][CM] + n * Dfrac[ip][mat][CDM]) + 
		  (Dfrac[ip][mat][CP] + Dfrac[ip][mat][CDP] / n) / n + Dfrac[ip][mat][CN];
E 2
I 2
	    tot = Dfrac[ip][mat][CN]
...
D 2
		tmp = gprt[CN] * Kcpl(I,mat,si,CN) + gprt[CP] * Kcpl(I,mat,si,CP) +
		      gprt[CDP] * Kcpl(I,mat,si,CDP) + gprt[CM] * Kcpl(I,mat,si,CM) +
