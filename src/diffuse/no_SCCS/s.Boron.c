h41439
s 00049/00022/00384
d D 2.1 93/02/03 14:46:46 suprem45 2 1
c Initial IV.GS release
e
s 00406/00000/00000
d D 1.1 93/02/03 14:41:16 suprem45 1 0
c date and time created 93/02/03 14:41:16 by suprem45
e
u
U
f e 0
...
D 2
#define Dix0(M)	impur[B].constant[M][1] /*pre exp constant with neutral V*/
#define DixE(M)	impur[B].constant[M][2] /*exp constant with neutral V*/
#define Dip0(M)	impur[B].constant[M][3] /*pre exp constant with neg V*/
#define DipE(M)	impur[B].constant[M][4] /*exp constant with neg V*/
#define Fi(M)	impur[B].constant[M][5] /*fractional interstitialcy*/
E 2
I 2
...
D 2
    ...
    if (is_specified(param, "Dip.0")) Dip0(mat)  = get_float( param, "Dip.0");
    if (is_specified(param, "Dip.E")) DipE(mat)  = get_float( param, "Dip.E");
