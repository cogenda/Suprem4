h07748
s 00070/00044/00618
d D 2.1 93/02/03 14:46:50 suprem45 2 1
c Initial IV.GS release
e
s 00662/00000/00000
d D 1.1 93/02/03 14:41:19 suprem45 1 0
c date and time created 93/02/03 14:41:19 by suprem45
e
u
U
f e 0
...
D 2
	    tot = n * ( Dfrac[ip][mat][CM] + n * Dfrac[ip][mat][CDP]) + 
		    (Dfrac[ip][mat][CP] + Dfrac[ip][mat][CDP] / n) / n +
		    Dfrac[ip][mat][CN];
E 2
I 2
	    tot = Dfrac[ip][mat][CN]
...
D 2
		tmp = gprt[CN] * Kcpl(V,mat,si,CN) + gprt[CP] * Kcpl(V,mat,si,CP) +
		      gprt[CDP] * Kcpl(V,mat,si,CDP) + gprt[CM] * Kcpl(V,mat,si,CM) +
