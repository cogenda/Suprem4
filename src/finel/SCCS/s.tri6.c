h23641
s 00000/00000/00310
d D 2.1 93/02/03 14:56:30 suprem45 2 1
c Initial IV.GS release
e
s 00310/00000/00000
d D 1.1 93/02/03 14:53:11 suprem45 1 0
c date and time created 93/02/03 14:53:11 by suprem45
e
u
U
f e 0
 ...
 *									*
 ************************************************************************/
tri6_stiff( stiff, wrhs, xl, disp, coeff, mat)
     double stiff[12][12];	/* The stiffness matrix */
     double wrhs[6][2];		/* The right hand side */
     double xl[6][2];		/* Coordinates of nodes */
     double disp[6][2];		/* Displacements of nodes */
 ...
 *									*
 ************************************************************************/
tri6_stress( mat, coeff, xl, ul, where, eps, sig, xsj)
    int mat;
    int (*coeff)();
    double xl[6][2];
    double ul[6][2];
 ...
 *--------------------------------------------------------------------*/
tri6_Snodal_stress( xl, ul, epsn, sign, coeff, mat, xsj)
     double xl[6][2];
     double ul[6][2];
     double epsn[6][3];
     double sign[6][3];
...
do_tri6_nodal_stress( xl, ul, epsn, sign, coeff, mat, xsj, smooth)
     double xl[6][2];
     double ul[6][2];
     double epsn[6][3];
     double sign[6][3];
